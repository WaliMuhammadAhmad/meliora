...
function App() {
  ...
  const words = ["Eco-Friendly Solutions",
  ...
  return (
    <AuroraBackground>
      ...
      >
        ...
        Meliora Products <br /> <span  className="font-extralight text-base md:text-4xl dark:text-neutral-200 py-4"><FlipWords words={words} /></span>
        </div>
